...
//getting the specific from table
if(isset($_GET['edit_pro'])){
	...
	//Getting the product relevent categories
	...
	//getting the exact brand for this products
...
<body bgcolor="#0066FF" >
   ...
   <table width="795" height="700" align="center">
   
    <tr>
     <td colspan="2" align="center"><h2>Update Or Edit Products</h2></td>
 ...
 ?> 
   ...
   <td><input type="file" name="product_img1"/><br><img src="../customer/images/<?php echo $p_img1; ?>" width="70" height="70" /></td>
   
   </tr>
   
   <tr>
   <td align="right"><b>Product Image2</b></td>
   <td><input type="file" name="product_img2"/><br><img src="../customer/images/<?php echo $p_img2; ?>" width="70" height="70" /></td>
   
   </tr>
   
   <tr>
   <td align="right"><b>Product Image3</b></td>
   <td><input type="file" name="product_img3"/><br><img src="../customer/images/<?php echo $p_img3; ?>" width="70" height="70" /></td>
 ...
 <?php
   ...
   $temp_name3 = $_FILES['product_img3']['tmp_name']; 
		...
		move_uploaded_file($temp_name1,"../customer/images/$product_img1");
		move_uploaded_file($temp_name2,"../customer/images/$product_img2");
		move_uploaded_file($temp_name3,"../customer/images/$product_img3");
